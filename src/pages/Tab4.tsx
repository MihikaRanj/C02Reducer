...
const Tab4: React.FC = () => {
    return (
        <IonPage>
            ...
            <IonItem color={'warning'} href='app/tab4' onClick={()=> {window.open('https://www.energystar.gov/productfinder/', '_system', 'location=yes')}}>ENERGY STAR Product Finder</IonItem>
            
            
            <br/>
            <br/>
            <IonText>The following resources have helped in creating this app:</IonText>
            <IonItem color={'warning'} href='app/tab4' onClick={()=> {window.open('https://www.epa.gov', '_system', 'location=yes')}}>U.S. Environmental Protection Agency</IonItem>
